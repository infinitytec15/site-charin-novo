...
import { ArrowRight, Zap, Droplet, Car, TrendingUp } from "lucide-react";
import { Button } from "@/components/ui/button";
import { Card, CardContent } from "@/components/ui/card";
import Header from "@/components/Header";

const PostosDeCombustivel = () => {
  return (
    <div className="min-h-screen bg-white">
      ...
      <section className="relative py-20 md:py-32 bg-[#0C1F38]">
        <div className="container relative z-10">
          ...
          >
            <h1 className="text-4xl md:text-6xl font-bold text-white leading-tight">
              Soluções de Recarga para Postos de Combustível
            </h1>
            <p className="text-lg text-gray-300">
              Prepare seu posto para o futuro da mobilidade e diversifique sua
              fonte de receita com estações de recarga elétrica.
            </p>
            <Button
        ...
        <div className="absolute inset-0 z-0">
          <img
            src="https://images.unsplash.com/photo-1603171892644-c97fb0cc0069?w=1600&q=80"
            alt="Posto de combustível com estações de recarga"
      ...
      <section className="py-20 bg-white">
        <div className="container">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            <div>
              <img
                src="https://images.unsplash.com/photo-1647500660918-0e0fae3a7a5d?w=800&q=80"
                alt="Estação de recarga em posto de combustível"
                className="rounded-xl shadow-lg w-full h-auto"
              />
            </div>
            <div className="space-y-6">
              <h2 className="text-3xl font-bold text-[#0C1F38] mb-4">
                Benefícios para Postos de Combustível
              </h2>
              <p className="text-gray-600">
                Adicionar estações de recarga elétrica ao seu posto de
                combustível é uma estratégia inteligente para o futuro do seu
                negócio:
              </p>
              <ul className="space-y-4">
                <li className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      Crie uma nova fonte de faturamento com o crescente mercado
                      de veículos elétricos, complementando seu negócio
                      tradicional.
                    </p>
                  </div>
                </li>
                <li className="flex items-start">
                  ...
                  <div>
                    <h3 className="font-bold text-[#0C1F38]">
                      Aumento de vendas na loja de conveniência
                    </h3>
                    <p className="text-gray-600">
                      Motoristas de veículos elétricos passam mais tempo no
                      posto durante o carregamento, aumentando o consumo na loja
                      de conveniência.
                    </p>
                  </div>
                </li>
                <li className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      Posicione seu negócio à frente da concorrência,
                      adaptando-se às mudanças do mercado e às novas demandas
                      dos consumidores.
                    </p>
                  </div>
                </li>
        ...
        <div className="container">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <Card className="border-none shadow-lg hover:shadow-xl transition-all duration-300">
              <CardContent className="p-6">
                <div className="bg-[#0C1F38]/10 p-4 rounded-full w-16 h-16 flex items-center justify-center mb-4">
                  <Droplet className="h-8 w-8 text-[#00FF99]" />
                </div>
                <h3 className="text-xl font-bold mb-2 text-[#0C1F38]">
                  Rede Ipiranga
                </h3>
                <p className="text-gray-600 mb-4">
                  Aumento de 35% nas vendas da loja de conveniência após a
                  instalação de carregadores rápidos em 10 postos da rede.
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="border-none shadow-lg hover:shadow-xl transition-all duration-300">
              <CardContent className="p-6">
                <div className="bg-[#0C1F38]/10 p-4 rounded-full w-16 h-16 flex items-center justify-center mb-4">
                  <Car className="h-8 w-8 text-[#00FF99]" />
                </div>
                <h3 className="text-xl font-bold mb-2 text-[#0C1F38]">
                  Posto Estrada Feliz
                </h3>
                <p className="text-gray-600 mb-4">
                  Retorno do investimento em apenas 14 meses com a implementação
                  de estações de recarga ultrarrápida em rodovia de alto fluxo.
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="border-none shadow-lg hover:shadow-xl transition-all duration-300">
              <CardContent className="p-6">
                ...
                <p className="text-gray-600 mb-4">
                  Crescimento de 28% no fluxo de clientes e aumento da
        ...
        <div className="container">
          <div className="max-w-3xl mx-auto text-center space-y-6">
            <h2 className="text-3xl md:text-4xl font-bold text-white">
              Prepare seu posto para o futuro da mobilidade
            </h2>
            <p className="text-lg text-gray-300">
              Nossa equipe de especialistas está pronta para desenvolver uma
              solução personalizada para seu posto de combustível.
            </p>
...
export default PostosDeCombustivel;
